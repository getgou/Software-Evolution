package android.app.printerapp.postPrinting.SolutionTreatment;
...
public class solutionTreatmentTestActivity extends AppCompatActivity implements Serializable, dialogComInterfaces.timeDialog, dialogComInterfaces.stringDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solution_treatment_test2);
        ...
        title.setText("Solution Treatment");
    }
    ...
    public void timeButtonPressed(View view) {
        ...
        bundleWithDelegate.putSerializable(enums.bundleKeys.dialogDelegate.getValue(), solutionTreatmentTestActivity.this);
        // Show time dialog
        TimePickerFragment<solutionTreatmentTestActivity> timePicker = new TimePickerFragment<>();
    ...
    public void fabPressed(View view) {
        ...
        LayoutInflater inflater = LayoutInflater.from(solutionTreatmentTestActivity.this);
        View dialogView = inflater.inflate(R.layout.activity_add_test_card_dialog, null);

        // Get a builder
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(solutionTreatmentTestActivity.this);
        ...
        alertDialogBuilder
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        partTestCardViewData newCard = new partTestCardViewData(temperature, timeevent, comment);
                        ...
                        if (!(TextUtils.isEmpty(temp.getText())) && (!(TextUtils.isEmpty(time.getText())))) {
                            if (timeevent.matches("^(?:(?:([01]?\\d|2[0-3]):)([0-5]?\\d):)([0-5]?\\d)$")) {
                                ...
                                createNewSolutionTestDatabaseContent(temperature, timeevent, comment);
                            } else {
    ...
    public void getDatabaseContent() {
        ...
        // Get a call
        Call<List<SolutionTreatmentTest>> call = endpoint.getSolutionTreatmentTest(qrcode, token);

        // Enqueue the call
        call.enqueue(new Callback<List<SolutionTreatmentTest>>() {
            @Override
            public void onResponse(Call<List<SolutionTreatmentTest>> call, Response<List<SolutionTreatmentTest>> response) {
                ...
                if (response.body() == null) {
                    ...
                    // Get the body
                    List<SolutionTreatmentTest> data = response.body();
            ...
            @Override
            public void onFailure(Call<List<SolutionTreatmentTest>> call, Throwable t) {
    ...
    public void updateDatabaseContent(String key, String newValue) {
        ...
        UpdateSolutionTreatment dataToStore = this.getSolutionTreatmentDataObject(key, newValue);
        ...
        // Get a call
        Call<String> call = endpoint.updateSolutionTreatmentData(dataToStore, token);
    ...
    public void createNewSolutionTestDatabaseContent(String temperature, String time, String comment) {
        // Get a printing data object containing the new content
        ...
        CreateSolutionTest data = new CreateSolutionTest();
        ...
        // Get a call
        Call<String> call = endpoint.createSolutionTest(data, token);
    ...
    public void createCards(List<SolutionTreatmentTest> data) {
    ...
    private UpdateSolutionTreatment getSolutionTreatmentDataObject(String key, String content) {
        // Local object
        UpdateSolutionTreatment data = new UpdateSolutionTreatment();
